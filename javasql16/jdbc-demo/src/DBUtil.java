...
//
//    private static final String UWSENAME ="root";
//    private static final String PAEEWORD ="123456";
//
...
//                    connection =  DriverManager.getConnection( URL, UWSENAME,PAEEWORD );
//                } finally{
//                    connection.close();
//                }
//
...
public class DBUtil {
   ...
   private static final String URL =  "jdbc:mysql://localhost:3306/student? useUnicode=true&characterEncoding=UTF-8&useSSL=true";
